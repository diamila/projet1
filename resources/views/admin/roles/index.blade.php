    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($roles) > 0 ? 'datatable' : '' }} dt-select">
                <thead>
                    <tr>
                        <th width="1" style="text-align:center;"><input type="checkbox" id="select-all" /></th>
                        <th width="1">@lang('global.roles.fields.name')</th>
                        <th width="1">@lang('global.roles.fields.permission')</th>
                        <th width="1">&nbsp;</th>
                    </tr>
                </thead>
